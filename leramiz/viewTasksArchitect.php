     ...
     <div class="col-md-9  col-sm-9">
            <div class="profile-content" style="height: 100%">
              <?php
                ...
                $employeePhoneNo = $_SESSION['employeePhoneNo'];
                $employeeType = $_SESSION['employeeType'];
                $sql = "SELECT * FROM task WHERE employeeEmailId = '$employeeEmailId'";
                ...
                if(mysqli_num_rows($result) > 0)
                {
                  echo '<div class="container-fluid">
                      <div class="row">
                        ...
                        {
                          echo '<tr>
                                    <td style="width:10%;">'.$row['taskId'].'</td>
                                    <td style="width:40%;">'.$row['task'].'</td>
                                    <td style="width:20%;">'.$row['assignDate'].'</td>';
                    echo "</tr>";                                   
                        }
                        echo "        </tbody>
                                </table>
