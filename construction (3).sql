...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2018 at 03:50 PM
...
CREATE TABLE `announcement` (
  ...
  `employeeType` varchar(100) NOT NULL DEFAULT 'architect',
  `announcement` varchar(500) NOT NULL DEFAULT 'Default Announcement',
...
INSERT INTO `announcement` (`employeeName`, `employeeType`, `announcement`, `announcementId`) VALUES
('Amit Mahajan', 'architect', 'ANNOUNCE', 1);
...
('Mohan Heights', 'displayImage', 'document/atmega 328.jpg.jpg', '', 0),
('Mohan Heights', 'displayImage', 'document/atmega 328.jpg.jpg', 'Amit Mahajan', 0),
('Mohan Heights', 'displayImage', 'document/atmega 328.jpg.jpg', 'Amit Mahajan', 0);
...
('Posted announcement', '2018-10-09 14:30:09', 'Amit Mahajan', 1, 1, 'architect'),
('Posted announcement', '2018-10-10 12:53:08', 'Amit Mahajan', 1, 2, 'architect'),
('Uploaded Report', '2018-10-11 13:52:42', 'Amit Mahajan', 1, 3, 'architect'),
('Uploaded Report', '2018-10-11 13:55:30', 'Amit Mahajan', 1, 4, 'architect');
...
('Mohan Heights', 'Badlapur', 200, 'http://www.ceconline.edu/qdig/college%20building.jpg', 'Amit Mahajan', '2018-09-09', '2018-09-16', '<div class=\"mapouter\"><div class=\"gmap_canvas\"><iframe width=\"600\" height=\"350\" id=\"gmap_canvas\" src=\"https://maps.google.com/maps?q=mohan%20heights&t=&z=13&ie=UTF8&iwloc=&output=embed\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\"></iframe><a href=\"https://www.pureblack.de\">website erstellen lassen</a></div><style>.mapouter{text-align:right;height:350px;width:600px;}.gmap_canvas {overflow:hidden;background:none!important;height:350px;width:600px;}</style></div>', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus egestas fermentum ornareste. Donec index lorem. Vestibulum  aliquet odio, eget tempor libero. Cras congue cursus tincidunt. Nullam venenatis dui id orci egestas tincidunt id elit. Nullam ut vuputate justo. Integer lacnia pharetra pretium. Casan ante ipsum primis in faucibus orci luctus et ultrice.'),
...
CREATE TABLE `report` (
  ...
  `employeeType` varchar(100) NOT NULL DEFAULT 'architect',
  `reportText` varchar(500) NOT NULL DEFAULT 'Default Report Text',
  `reportLink` varchar(500) NOT NULL,
...
INSERT INTO `report` (`employeeEmailId`, `employeeType`, `reportText`, `reportLink`, `reportId`, `reportDate`) VALUES
('amit.mahajan@somaiya.edu', 'architect', 'Testing reports', 'report/ldr.jpg.jpg', 7, '2018-10-11 14:09:46'),
('amit.mahajan@somaiya.edu', 'architect', 'AGAIN AGAIN AGAIN', 'report/buzzer.jpg.jpg', 8, '2018-10-11 14:09:46'),
('amit.mahajan@somaiya.edu', 'architect', 'hh', 'report/atmega 328.jpg.jpg', 9, '2018-10-11 14:09:46');
